...
1 - name of cipher
2 - sbox or prob
3 - DDT points (2/4/6), - for all 

Example
python Inequalities_Reduction.py GIFT sbox -
python Inequalities_Reduction.py GIFT sbox 4
"""
import sys
import math
import numpy as np
#import gurobipy              # if gurobi is used
#from gurobipy import GRB     # if gurobi is used
...
########################################## Linear Inequality Reduction using MILP ############################
